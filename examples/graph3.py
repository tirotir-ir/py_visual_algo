...
bfs_result, bfs_edges = bfs_with_edges(graph_dict, start="A")
print("BFS:", bfs_result)
visualize_graph(graph, highlight_edges=bfs_edges, title="BFS Traversal")

# Run and Visualize DFS
dfs_result, dfs_edges = dfs_with_edges(graph_dict, start="A")
print("DFS:", dfs_result)
visualize_graph(graph, highlight_edges=dfs_edges, title="DFS Traversal")
